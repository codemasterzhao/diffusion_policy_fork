...
class TrainEquiLowDimWorkspace(BaseWorkspace):
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}",
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # update ema
                        # if cfg.traindiffusion_policy/config/train_diffusion_transformer_lowdim_workspace.yamling.use_ema:
                        #     ema.step(self.model)
...
def main(cfg):
    workspace = TrainEquiLowDimWorkspace(cfg)
    workspace.run()
